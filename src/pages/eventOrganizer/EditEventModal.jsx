        ...
        return (
          <>
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4 bg-black bg-opacity-40 z-50">
              <div className="bg-white rounded-lg w-full sm:w-3/4 md:w-2/3 lg:w-1/2 max-h-[90vh] h-auto p-6 flex-col items-end relative dark:bg-[#1f1f1f]">
                <button
                  className="absolute top-4 right-4 text-gray-600 hover:text-gray-800 dark:text-white"
                  onClick={() => setIsModalOpen(false)}
                >
                  ✖
                </button>
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 dark:text-violet-500 ">
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full rounded-md size-10 bg-gray-200 pl-4 border-2 border-gray-300 focus:border-[#6366f1] focus:ring-1 focus:ring-[#6366f1] focus:outline-none dark:text-black"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="bg-gray-200 pl-4 w-full size-10 rounded-md border-2 border-gray-300 focus:border-[#6366f1] focus:ring-1 focus:ring-[#6366f1] focus:outline-none dark:text-black"
                        onChange={handleChange}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="bg-gray-200 pl-4 w-full size-10 border-2 rounded-md border-gray-300 focus:border-[#6366f1] focus:ring-1 focus:ring-[#6366f1] focus:outline-none dark:text-black"
                        onChange={handleChange}
                      />
                    </div>
                  </div>
