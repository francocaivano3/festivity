...
const Ticket = ({event}) => {
    ...
    return (
        <div id="ticket-container" className="w-4/5 md:w-3/4 text-white rounded-2xl p-6 sm:p-8 lg:p-10 flex flex-col justify-center mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                ...
                <div className="text-right mt-4 sm:mt-0 bg-[#8082fa] p-4 rounded-xl">
                    <div className="text-2xl sm:text-3xl lg:text-4xl font-bold">${event.amount}</div>
                </div>
            </div>
