...
import { AlignLeft, Trash2, RefreshCcw } from "lucide-react";
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-between pt-4">
                ...
                <button
                  type="button"
                  className="bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 flex "
                  onClick={handleDelete}
                >
                  <span className="mr-2">Borrar cuenta</span>
                  <Trash2 />
                </button>
                <button
                  type="submit"
